    ...
    public function run(): void
    {
        $services = [
            [
                ...
                'slug' => 'sea-freight',
                'icon' => 'vessel',
                'summary' => 'Full container and groupage services on the main east-west and north-south trades, with weekly departures on our regular lanes.',
                'highlights' => ['FCL in 20ft, 40ft and 40ft high cube', 'LCL consolidations on regular lanes', 'Port to port or door to door', 'Booking, bill of lading and release handled by one desk'],
                'description' => <<<'TEXT'
...
We book directly with carriers on the main trades and confirm the space before we confirm your rate, so the sailing you are quoted is the sailing you get. Containers can be stuffed at your own premises or at our warehouse, and we arrange haulage at both ends.

## Groupage and part loads

If your cargo does not fill a container, it travels in a consolidation with other shipments on the same lane. You pay for the space you use, which is calculated on whichever is greater, volume or weight.
...
Transit time depends on the lane, the carrier's rotation and whether the service is direct or via a transhipment hub. We quote the realistic door to door time, not just the port to port sailing time, and we tell you when a vessel is rolled.
TEXT,
            ],
            [
                'title' => 'Air Freight',
                'slug' => 'air-freight',
                'icon' => 'aircraft',
                'summary' => 'Airport to airport and door to door air cargo where the delivery date matters more than the freight cost.',
...
TEXT,
            ...
            [
                ...
                'icon' => 'customs',
                'summary' => 'Import and export declarations prepared and lodged by our own brokerage desk, with duty and tax calculated before the cargo arrives.',
                ...
                'description' => <<<'TEXT'
Most delays at the border are document problems, not cargo problems. Our brokerage desk prepares declarations from the commercial documents you send us and raises questions early, while there is still time to fix them.
