<section class="bg-ink-950">
    <div class="mx-auto flex max-w-6xl flex-col items-start gap-6 px-gutter py-section-sm sm:flex-row sm:items-center sm:justify-between">
        <div class="max-w-xl">
            <h2 class="text-title font-semibold text-white">{{ setting('home.cta_heading') }}</h2>
